...
let readAllData = (modifiedFile) => new Promise(async (res, rej) => {
...
// read all pages
let readAllPage = (modifiedFile) => new Promise(async (res, rej) => {
  // get all the files path
  let allPageFiles
  let pageFiles = {
    content: [],
...
// read all posts
let readAllPost = (modifiedFile) => new Promise(async (res, rej) => {
  // get all the files path
  let allPostFile
  let postFiles = {
    content: [],
